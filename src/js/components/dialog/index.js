...
const Dialog = (() => {
  ...
  class Dialog {
    constructor(options = {}) {
      ...
      this.clickCancelableHandler = event => this.onOutsideDialog(event)
    }
    ...
    onHidden() {
      ...
      backdrop.removeEventListener('transitionend', event => this.onHidden(event), false)
    ...
    hide() {
      ...
      const backdrop = this.getBackdrop()
      backdrop.addEventListener('transitionend', event => this.onHidden(event), false)
