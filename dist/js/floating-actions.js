 ...
 */
	...
	Phonon.FloatingAction = function () {
		return {
			listenTo: (function (_listenTo) {
				var _listenToWrapper = function listenTo(_x) {
					return _listenTo.apply(this, arguments);
				};

				_listenToWrapper.toString = function () {
					return _listenTo.toString();
				};

				return _listenToWrapper;
			})(function (page) {
				listenTo(page);
				return this;
			})
