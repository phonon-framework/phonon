...
;(function (window, document, Phonon, undefined) {
  ...
  var findTrigger = function findTrigger(target) {
    var triggers = document.querySelectorAll("[data-alert-id], [data-alert-close]"),
        i;
  ...
  */
  ...
  Phonon.Alert = function (el) {
    ...
    return {
      open: (function (_open) {
        var _openWrapper = function open() {
          return _open.apply(this, arguments);
        };

        _openWrapper.toString = function () {
      ...
      close: (function (_close) {
        var _closeWrapper = function close() {
          return _close.apply(this, arguments);
        };

        _closeWrapper.toString = function () {
      ...
      toggle: (function (_toggle) {
        var _toggleWrapper = function toggle() {
