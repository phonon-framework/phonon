 ...
 */
  ...
  */
		...
		var _onUpdate = function _onUpdate(callback) {
 ...
 */
	api.attach = function (viewModel, el, scope) {
		...
		var elements = el.querySelectorAll("[data-knity]"),
		    l = elements.length,
		    i = l - 1;
		for (; i >= 0; i--) {
 ...
 */
	var addInputListener = function addInputListener(el, observable) {
  ...
  * @private
 */
	var bindElement = function bindElement(el) {
  ...
  * @private
 */
	var updateElement = function updateElement(el, nodeValue) {
  ...
  * @private
 */
	var findObservable = function findObservable(varName) {
  ...
  * @private
 */
	var foreach = function foreach(el, array) {
  ...
  * @private
 */
	var setClass = function setClass(el, cssClass) {
