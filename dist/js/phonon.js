/*!
  * Phonon v2.0.0-alpha.1 (https://phonon-framework.github.io)
    ...
    ***************************************************************************** */
      ...
      Collapse.attachDOM = function () {
        ...
        document.addEventListener(utils.Event.CLICK, function (event) {
          ...
          if (dataToggleAttr && dataToggleAttr === className) {
            ...
            var collapseComponent = utils.Observer.getComponent(className, {
              element: collapse
            });
      ...
      Modal.attachDOM = function () {
        ...
        document.addEventListener(utils.Event.CLICK, function (event) {
          ...
          if (toggleEl) {
            ...
            var modalComponent = utils.Observer.getComponent(className, {
              element: modal
            });
              ...
              switch (_a.label) {
                ...
                case 1:
                  ...
                  _onShown = function onShown() {
                    ...
                    element.removeEventListener(utils.Event.TRANSITION_END, _onShown);
                  };

                  element.addEventListener(utils.Event.TRANSITION_END, _onShown);
    ...
    var OffCanvas = function (_super) {
      ...
      OffCanvas.attachDOM = function () {
        ...
        document.addEventListener(utils.Event.CLICK, function (event) {
          ...
          if (toggleEl) {
            ...
            var offCanvasComponent = utils.Observer.getComponent(className, {
              element: offCanvas
            });
      ...
      OffCanvas.prototype.onElementEvent = function (event) {
        ...
        if (event.type === 'keyup' && !closableKeyCodes.find(function (k) {
          return k === event.keyCode;
        })) {
          return;
        }
      ...
      OffCanvas.prototype.show = function () {
        ...
        (function () {
          return __awaiter(_this, void 0, void 0, function () {
            var _onShown, container, containerShowClass, el;
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 1:
                  ...
                  if (this.animate) {
                    el.addEventListener(utils.Event.TRANSITION_END, _onShown);
      ...
      OffCanvas.prototype.hide = function () {
        ...
        if (!this.showAside) {
          ...
          var onHidden_1 = function onHidden_1() {
            if (_this.animate) {
              element.classList.remove('animate');
            }
      ...
      OffCanvas.prototype.attachEvents = function () {
        ...
        var element = this.getElement();
        Array.from(element.querySelectorAll('[data-dismiss]') || []).forEach(function (button) {
          return _this.registerElement({
            target: button,
            event: utils.Event.CLICK
          });
    ...
    var Selectbox = function (_super) {
      ...
      Selectbox.prototype.onElementEvent = function (event) {
        ...
        if (event.type === utils.Event.START) {
          ...
          var dismissButton = utils.Selector.closest(target, '[data-dismiss="selectbox"]');
    ...
    var componentCreator = function componentCreator(component, options) {
      if (options === void 0) {
        options = {};
      }
    ...
    var api = {
      accordion: function accordion(options) {
        return componentCreator(Accordion, options);
      },
      alert: function alert(options) {
        return componentCreator(Alert, options);
      },
      modal: function modal(options) {
        return componentCreator(Modal, options);
      },
      modalConfirm: function modalConfirm(options) {
        return componentCreator(ModalConfirm, options);
      },
      modalLoader: function modalLoader(options) {
        return componentCreator(ModalLoader, options);
      },
      modalPrompt: function modalPrompt(options) {
        return componentCreator(ModalPrompt, options);
      },
      loader: function loader(options) {
        return componentCreator(Loader, options);
      },
      collapse: function collapse(options) {
        return componentCreator(Collapse, options);
      },
      notification: function notification(options) {
        return componentCreator(Notification, options);
      },
      offCanvas: function offCanvas(options) {
        return componentCreator(OffCanvas, options);
      },
      tab: function tab(options) {
        return componentCreator(Tab, options);
      },
      selectbox: function selectbox(options) {
        return componentCreator(Selectbox, options);
      },
      progress: function progress(options) {
        return componentCreator(Progress, options);
      }
    };
