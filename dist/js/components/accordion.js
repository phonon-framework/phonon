/*!
  * Accordion v2.0.0-alpha.1 (https://github.com/quark-dev/Phonon-Framework)
    ...
    Collapse.attachDOM = function () {
        ...
        document.addEventListener(Util.Event.CLICK, function (event) {
            ...
            if (dataToggleAttr && dataToggleAttr === className) {
                ...
                var collapseComponent = Util.Observer.getComponent(className, { element: collapse });
...
var Accordion = (function (_super) {
    ...
    function Accordion(props) {
        ...
        _this.registerElement({ target: element, event: Util.Event.CLICK });
        return _this;
    }
