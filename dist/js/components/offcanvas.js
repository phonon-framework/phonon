/*!
  * Offcanvas v2.0.0-alpha.1 (https://phonon-framework.github.io)
  ...
  OffCanvas.attachDOM = function () {
    ...
    document.addEventListener(Util.Event.CLICK, function (event) {
      ...
      if (toggleEl) {
        ...
        var offCanvasComponent = Util.Observer.getComponent(className, {
          element: offCanvas
        });
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (this.animate) {
                el.addEventListener(Util.Event.TRANSITION_END, _onShown);
