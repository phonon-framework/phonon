    ...
    Phonon.i18n = function (options) {
        ...
        return {
            getAll: (function (_getAll) {
                var _getAllWrapper = function getAll(_x) {
                    return _getAll.apply(this, arguments);
                };

                _getAllWrapper.toString = function () {
                    return _getAll.toString();
                };

                return _getAllWrapper;
            })(function (callback) {
                getAll(callback);
                return this;
            }),
            get: (function (_get) {
                var _getWrapper = function get(_x, _x2) {
            ...
            bind: (function (_bind) {
                var _bindWrapper = function bind(_x, _x2) {
                    return _bind.apply(this, arguments);
                };

                _bindWrapper.toString = function () {
                    return _bind.toString();
                };
            ...
            setPreference: (function (_setPreference) {
                var _setPreferenceWrapper = function setPreference(_x) {
                    return _setPreference.apply(this, arguments);
                };

                _setPreferenceWrapper.toString = function () {
                    return _setPreference.toString();
                };

                return _setPreferenceWrapper;
            })(function (preference) {
                setPreference(preference);
                return this;
            }),
            getPreference: (function (_getPreference) {
                var _getPreferenceWrapper = function getPreference() {
                    return _getPreference.apply(this, arguments);
                };

                _getPreferenceWrapper.toString = function () {
                    return _getPreference.toString();
                };

                return _getPreferenceWrapper;
            })(function () {
                return getPreference();
            }),
            getLocale: (function (_getLocale) {
                var _getLocaleWrapper = function getLocale() {
                    return _getLocale.apply(this, arguments);
                };

                _getLocaleWrapper.toString = function () {
                    return _getLocale.toString();
                };

                return _getLocaleWrapper;
            })(function () {
                return getLocale();
            })
        };
